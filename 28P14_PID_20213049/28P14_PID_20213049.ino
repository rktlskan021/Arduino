...
#define EMA_ALPHA 0.2     // EMA 필터 값을 결정하는 ALPHA 값. 작성자가 생각하는 최적값임.
...
float dist_f, dist_ff; //  거리와 노이즈 필터 적용 후 거리를 저장하기 위한 변수
...
pterm = iterm = dterm = iterm = 0; // [2635] pid 제어값에서 우선 p 만 사용하도록
